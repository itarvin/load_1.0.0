...
class Members extends Base
{
    ...
    public function index()
    {
        ...
        if(request()->isPost())
        {
            $result = $member->adminSearch(Request::param(),'true',$this->uid,'false');
        }
        $this->assign([
            'list'   => $result['list'],
            'count'  => $result['count'],
    ...
    public function edit()
    {
        ...
        public function recycle()
        {
            ...
            if(request()->isPost())
            {
                $result = $member->adminSearch(Request::param(),'true',$this->uid,'true');
            }
